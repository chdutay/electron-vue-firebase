...
== conversion en application de download

----
npm install request
----

Add configuration in JS file
...
[TIP]
--
Il y a un problème avec webpack et fs, il faut modifier sa config comme cela :
...
https://zestedesavoir.com/tutoriels/996/vos-applications-avec-electron/#8-publier-son-application

----
npm install electron-packager -g --save-dev

electron-packager . --all --name "electron-downloader" --version "1.0.0"
----
